...
<div class="container-fluid pt-5">
    <div class="text-center mb-4">
        <h2 class="section-title px-5"><span class="px-2">Thông tin liên hệ</span></h2>
    </div>
    <div class="col-lg-7 m-auto w-100 mb-5">
        <h5 class="font-weight-semi-bold mb-3">Liên lạc với chúng tôi</h5>
        <p>Đem lại sự hài lòng cho quý khách là niềm vinh dự của cửa hàng EShopper</p>
        {!!$contact->map_contact!!}
