...
<div class="container-fluid">
    ...
    <div class="container-fluid bg-secondary">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">{{$selectByBrand->name_brand}}</h1>
            <div class="d-inline-flex">
                <p class="m-0"><a href="">Trang chủ</a></p>
                <p class="m-0 px-2">-</p>
                <p class="m-0">{{$selectByBrand->name_brand}}</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3 col-md-12">
                ...
                <div class="border-bottom mb-4 pb-4">
                    ...
                    <form>
                        <?php
                            $nameBrand = $selectByBrand->name_brand;
                            $routeAll = route('brand.productByBrand',[$nameBrand]);
                            $routeUnder5 = route('brand.productByBrand',[$nameBrand, 'max' => 5000000]);
                            $route5To10 = route('brand.productByBrand',[$nameBrand, 'min' => 5000000, 'max' => 10000000]);
                            $route10To20 = route('brand.productByBrand',[$nameBrand, 'min' => 10000000, 'max' => 20000000]);
                            $route20To30 = route('brand.productByBrand',[$nameBrand, 'min' => 20000000, 'max' => 30000000]);
                            $routeUp30 = route('brand.productByBrand',[$nameBrand, 'min' => 30000000]);
                        ?>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="row pb-3">
                    <div class="col-12 pb-1 mb-5">
                        <div class="shadow bg-light w-100 h-100 p-3" style="border-radius: 15px;">
                            <div class="d-flex align-items-center justify-content-between ">
                                <form action="{{route('brand.productByBrand', $selectByBrand->name_brand)}}" method="GET">
                                ...
                                <div class="dropdown ml-4">
                                    <button class="btn border-info rounded dropdown-toggle f-14" type="button" id="triggerId" data-toggle="dropdown" aria-haspopup="true"
                                            aria-expanded="false">
                                                Sắp xếp theo
                                    </button>
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="triggerId">
                                        <a class="dropdown-item f-14" href="{{route('brand.productByBrand',['nameBrand' => $selectByBrand->name_brand, 'filterPrice' => 'asc'])}}"><i class="fa-solid fa-arrow-up-wide-short pr-1"></i>Giá tăng dần</a>
                                        <a class="dropdown-item f-14" href="{{route('brand.productByBrand',['nameBrand' => $selectByBrand->name_brand, 'filterPrice' => 'desc'])}}"><i class="fa-solid fa-arrow-down-wide-short pr-1"></i>Giá thấp dần</a>
                                        <a class="dropdown-item f-14" href="{{route('brand.productByBrand',['nameBrand' => $selectByBrand->name_brand, 'filterPrice' => 'popular'])}}"><i class="fa-solid fa-arrow-up-1-9 pr-1"></i>Phổ biến nhất</a>
                                        <a class="dropdown-item f-14" href="{{route('brand.productByBrand',['nameBrand' => $selectByBrand->name_brand, 'filterPrice' => 'evaluate'])}}"><i class="fa-solid fa-filter pr-1"></i>Đánh giá cao</a>
                                        <a class="dropdown-item f-14" href="{{route('brand.productByBrand',['nameBrand' => $selectByBrand->name_brand, 'filterPrice' => 'name'])}}"><i class="fa-solid fa-arrow-up-a-z"></i> Tên từ A->Z</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    @if($searchProduct && $errorFilter == '')
                    <div class="col-12 pb-3">
                        <span class="text-dark">{{$numberFindProduct}}</span> kết quả trả về cho từ khóa 
                        <span class="text-dark">"{{$searchProduct}}"</span>
                    </div>
                    @elseif($errorFilter != '')
                    <div class="col-12 pb-3">
                    ...
                    @endif
                    @if(isset($selectProductByBrand))
                    @foreach($selectProductByBrand as $key => $spbb)
                    <div class="col-lg-3 col-md-3 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="detail-product d-flex justify-content-center bg-light border rounded-bottom border-info">
                                <a href="{{route('product.detailProduct',['idProduct'=>$spbb->id])}}" class="link-detail p-2 btn btn-light flex-fill me-1 p-0 f-16 rounded-bottom"><span>Xem chi tiết</span></a>
                            </div>
                        </div>
                    </div>
                    @endforeach
                    ...
                    <div class="col-12 pb-1">
                        <nav aria-label="Page navigation">
                          <ul class="pagination justify-content-center mb-3">
                            ...
                            <li class="page-item active"><a class="page-link" href="#">{!!$selectProductByBrand->links()!!}</a></li>
                            <li class="page-item">
