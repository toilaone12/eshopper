                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <div class="dropdown ml-4">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="triggerId">
                                    <a class="dropdown-item f-14" href="{{route('brand.productByBrand',['nameBrand' => $selectByBrand->name_brand, 'filterPrice' => 'asc'])}}">Giá tăng dần</a>
                                    <a class="dropdown-item f-14" href="{{route('brand.productByBrand',['nameBrand' => $selectByBrand->name_brand, 'filterPrice' => 'desc'])}}">Giá thấp dần</a>
                                    <a class="dropdown-item f-14" href="{{route('brand.productByBrand',['nameBrand' => $selectByBrand->name_brand, 'filterPrice' => 'popular'])}}">Phổ biến nhất</a>
                                    <a class="dropdown-item f-14" href="{{route('brand.productByBrand',['nameBrand' => $selectByBrand->name_brand, 'filterPrice' => 'evaluate'])}}">Đánh giá cao</a>
                                    <a class="dropdown-item f-14" href="{{route('brand.productByBrand',['nameBrand' => $selectByBrand->name_brand, 'filterPrice' => 'name'])}}">Tên từ A->Z</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="{{url('images/product/'.$spbb->image_product)}}" alt="">
                            </div>
                            <div class="card-body border-left border-right text-center spbb-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3">{{$spbb->name_product}}</h6>
                                <div class="d-flex justify-content-center">
                                    <h6>{{number_format($spbb->price_product,0,',','.')}} ₫</h6><h6 class="text-muted ml-2"><del class="f-14">{{number_format($spbb->price_product,0,',','.')}} ₫</del></h6>
                                </div>
                            </div>
